...
<p align="center"><a href="https://github.com/taktikorg/dicta-harum/tree/master/docs"><strong>Docs: Getting Started →</strong></a></p>
<p align="center"><a href="https://libauth.org/#md:api-overview">API Reference</a></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@taktikorg/dicta-harum"><img src="https://img.shields.io/npm/v/@taktikorg/dicta-harum.svg" alt="NPM version" /></a>
  <a href="https://codecov.io/gh/taktikorg/dicta-harum"><img src="https://img.shields.io/codecov/c/github/taktikorg/dicta-harum/master.svg" alt="Codecov" /></a>
  <a href="https://github.com/taktikorg/dicta-harum/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/taktikorg/dicta-harum/ci.yml?branch=master" alt="CI" /></a>
  ...
  <a href="https://www.npmjs.com/package/@taktikorg/dicta-harum"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@taktikorg/dicta-harum"></a>
  <a href="https://github.com/taktikorg/dicta-harum"><img src="https://img.shields.io/github/stars/taktikorg/dicta-harum.svg?style=social&logo=github&label=Stars" alt="GitHub stars" /></a>
</p>
...
To get started, install `@taktikorg/dicta-harum`:

```sh
npm install @taktikorg/dicta-harum
# OR
yarn add @taktikorg/dicta-harum
```

And import the functionality you need:

```ts
import { secp256k1 } from '@taktikorg/dicta-harum';
...
- [Installation](https://github.com/taktikorg/dicta-harum/blob/master/docs/install.md)
- [Handling Errors](https://github.com/taktikorg/dicta-harum/blob/master/docs/errors.md)
- [Cryptography](https://github.com/taktikorg/dicta-harum/blob/master/docs/crypto.md)
- [Keys](https://github.com/taktikorg/dicta-harum/blob/master/docs/keys.md)
- [Addresses](https://github.com/taktikorg/dicta-harum/blob/master/docs/addresses.md)
- [Verifying Transactions](https://github.com/taktikorg/dicta-harum/blob/master/docs/verify-transactions.md)
- [Wallets & Transaction Creation](https://github.com/taktikorg/dicta-harum/blob/master/docs/wallets.md)
...
Libauth's test suite includes a set of cross-implementation Virtual Machine Bytecode (VMB) test vectors for each supported VM. See [`Libauth VMB Tests`](https://github.com/taktikorg/dicta-harum/blob/master/src/lib/vmb-tests/readme.md) for details.
...
Pull Requests welcome! Please see [`CONTRIBUTING.md`](https://github.com/taktikorg/dicta-harum/blob/master/.github/CONTRIBUTING.md) for details.
